...
public class Analyze {
    ...
    public static List<Tuple> averageScoreBySubject(Stream<Pupil> stream) {
        return  stream
                ...
                .entrySet()
                .stream()
                .map(tuple -> new Tuple(tuple.getKey(), tuple.getValue())).collect(Collectors.toList());
    }
    ...
    public static Tuple bestSubject(Stream<Pupil> stream) {
        return  stream
                ...
                .entrySet()
                .stream()
                .map(tuple -> new Tuple(tuple.getKey(), tuple.getValue())).max(Comparator.comparing(Tuple::score))
                .orElse(null);
    }
}